...
class TermConditionView extends GetView<ProfileController> {
  TermConditionView({
    super.key,
...
// Term Condition Content Widget
class _TermConditionContent extends StatefulWidget {
  @override
  State<_TermConditionContent> createState() => _TermConditionContentState();
}

class _TermConditionContentState extends State<_TermConditionContent> {
  @override
  Widget build(BuildContext context) {
    return Column(
